 ...
 * Generated at: 2017-04-03 05:01:26 UTC
...
public final class DiemChuan_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t<p class=\"title\">XÁC ĐỊNH ĐIỂM CHUẨN</p>\r\n");
      out.write("\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t<div class=\"col-md-6 form-group\">\r\n");
      out.write("\t\t\t\t\t<label class=\"col-md-4\">Điểm liệt:</label>\r\n");
      out.write("\t\t\t\t\t<div class=\"col-md-8\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"number\" class=\"form-control\" name=\"diemliet\">\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"col-sm-6 form-group\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"radio\" name=\"\" checked><label>Bằng hoặc nhỏ hơn điểm liệt</label><br>\r\n");
      out.write("\t\t\t\t\t\t<input type=\"radio\" name=\"\"><label>Nhỏ hơn điểm liệt</label>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"form-group row\">\r\n");
      out.write("\t\t\t\t\t<label class=\"col-md-6\" style=\"padding-left: 30px;\">Điểm chuẩn cho khu vực 3 - không ưu tiên:</label>\r\n");
      out.write("\t\t\t\t\t<div class=\"col-md-6\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"number\" class=\"form-control\" name=\"diemchuan\">\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"btn-gr\">\r\n");
      out.write("\t\t\t\t\t<button type=\"submit\" class=\"btn btn-success btn-all\" name=\"kt\">Kiểm tra</button>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>KV - Đối tượng</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>Điểm</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>Số TS Đạt</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>Số TS Không Đạt</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>Số TS Bị Điểm Liệt</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>Tổng</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>Khu vực 3 - KUT</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>15.0</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>20</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>1</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>0</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>21</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t<div class=\"btn-gr\">\r\n");
      out.write("\t\t\t\t\t<button type=\"submit\" class=\"btn btn-success btn-all\" name=\"xddc\">Xác định điểm chuẩn</button>\r\n");
      out.write("\t\t\t\t</div>\t\t\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
